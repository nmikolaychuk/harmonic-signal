...
// harmonic_signal.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CharmonicsignalApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CharmonicsignalApp

CharmonicsignalApp::CharmonicsignalApp()
{
...
// Единственный объект CharmonicsignalApp

CharmonicsignalApp theApp;


// Инициализация CharmonicsignalApp

BOOL CharmonicsignalApp::InitInstance()
{
